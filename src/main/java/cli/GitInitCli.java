...
public final class GitInitCli implements Callable<Integer> {
    ...
    String path;
    @CommandLine.Parameters(index = "1", defaultValue = "unknown author",description = "Author name")
    String name;
    @CommandLine.Parameters(index = "2", defaultValue = "unknown@email.com",description = "Author email")
    String email;
